...
return {
  slash  = { path="assets/fx/slash.png",      frameW=32, frameH=32, frames={"1-4", 1},    duration=0.07 },
  ...
  heal   = { path="assets/fx/heal.png",       frameW=32, frameH=32, frames={"1-5", 1},    duration=0.07 },
}